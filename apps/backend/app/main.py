...
from app.routers import config_router, enrichment_router, health_router, jobs_router, resumes_router, job_matcher_router
...
app.include_router(job_matcher_router, prefix="/api/v1")
